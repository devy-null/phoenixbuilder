# FROM: https://www.kauffmann.nl/2019/03/04/how-to-install-docker-on-windows-10-without-hyper-v/
...
$json = Invoke-WebRequest https://download.docker.com/components/engine/windows-server/index.json -UseBasicParsing | ConvertFrom-Json
